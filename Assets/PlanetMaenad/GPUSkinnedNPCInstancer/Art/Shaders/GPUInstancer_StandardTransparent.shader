Shader "Planet Maenad/GPUInstancer/GPU Instance Standard Transparent" 
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
		#pragma surface surf Standard fullforwardshadows addshadow vertex:vert alphatest:_Cutoff alpha:fade
